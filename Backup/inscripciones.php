...
<div class="right">
 ...
 <div class="content">
	<h1>Inscripciones</h1>
	<br />
	<p>¡Hola! Bienvenido a la sección de inscripciones, si uno o m&aacute;s cursos te interesaron, entonces te invitamos a que te registres, 
    aqu&iacute; abajo est&aacute;n los links para cada curso en el cual podr&aacute;s ver m&aacute;s info y anotarte para el o los que te laten.</p>
    <p>Las inscripciones son individuales por cada curso, osea que hay que inscribirse en cada curso de forma independiente.</p>
    
    <br /> <br /> <br />
    <h3>Proximamente disponibles</h3>
    
   <!-- <div class="list">
    	<ul style="margin-left:200px">
        	<li> <a href="inscripcionesEv1.php"> Flash</a></li>
    		<li> <a href="inscripcionesEv2.php">Blender</a></li>
        	<li> <a href="inscripcionesEv3.php">Unity</a></li>
        	<li> <a href="inscripcionesEv4.php">Concurso SGGDL</a></li>
    	</ul>
 	</div>-->
