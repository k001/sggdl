<?php session_start();
require_once 'registrationEv3.php';
...
<div class="right">
 ...
 <div class="content">
	<h1>UNITY</h1>
	<br />
	<p> Aqu&iacute; debo meter una muy linda descripci&oacute;n sobre el curso de UNITY, pero ahorita urge m&aacute;s acabar con la parte t&eacute;cnica, as&iacute; que se las debo.</p>
...
<?php if ($registration->status == "init" || !empty($registration->verified_user)): ?>
	...
	<div class="login-buttons">
		<div class="twitter-button">
			...
			<?php else: ?>
				<a href="twitterEv3/redirect.php"><img src="images/twitter_signin.png" alt="Registrate con Twitter" title="Registrate con Twitter"></a>
			<?php endif ?>
		</div>
...
<?php if ( !$verified_is_registered && ($registration->status == "twitter_verified" || $registration->status == "facebook_form" || 
	...
	<div class="register_container">
		...
		<div class="register_right">
			<form action="/inscripcionesEv3.php" method="post" accept-charset="utf-8" style:"margin: 0px;">
