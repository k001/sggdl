<?php 
session_start();
require_once 'registrationEv4.php';
...
<div class="right">
 ...
 <div class="content">
	<h1>Concurso Social Gamers GDL</h1>
	<br />
	<p> Para poder participar en este evento es necesario que te registres, te recordamos que para este concurso el registro no tiene costo, así que simplemente anotate, asiste y diviertete.</p>
...
<?php if ($registration->status == "init" || !empty($registration->verified_user)): ?>
	...
	<div class="login-buttons">
		<div class="twitter-button">
			...
			<?php else: ?>
				<a href="twitterEv4/redirect.php"><img src="images/twitter_signin.png" alt="Registrate con Twitter" title="Registrate con Twitter"></a>
			<?php endif ?>
		</div>
...
<?php if ( !$verified_is_registered && ($registration->status == "twitter_verified" || $registration->status == "facebook_form" || 
	...
	<div class="register_container">
		...
		<div class="register_right">
			<form action="/inscripcionesEv4.php" method="post" accept-charset="utf-8" style:"margin: 0px;">
