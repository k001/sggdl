...
class Registration {
	...
	private function verify_form() {
		if (empty($this->params['name']) || empty($this->params['activity'])) {
			...
			$this->message = "Ser&iacute;a mejor si nos dijeras tu nombre y tu plan para el d&iacute;a.";
			return false;
		}
	...
	private function verify_twitter() {
		require_once('twitterEv2/twitteroauth.php');
		require_once('twitterEv2/config.php');
